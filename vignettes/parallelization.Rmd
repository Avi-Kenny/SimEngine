...
Note that some Slurm users may need to instead run `--export=ALL,sim_run='first'`, `--export=ALL,sim_run='main'`, and `--export=ALL,sim_run='last'` for code to run properly; this seems to be an issue with newer versions of Slurm.
